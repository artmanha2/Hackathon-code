...
<html lang ="pt-br">
    ...
    <body>
        ...
        <center>
            ...
            <form method="get" action="http://inf.fw.iffarroupilha.edu.br/~vitor.schneider/BAKOFTEC/loguinuser.php"><button class="btn btn-warning" type="submit"> Sair </button></form>
        </center>    
    </body>
